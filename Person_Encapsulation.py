...
class Person:
    ...
    name = property(fget=get_name, fset=set_name, fdel=None, doc='Name of Person')
    age = property(fget=get_age, fset=set_age, fdel=None, doc='Age of Person')
    sex = property(fget=get_sex, fset=set_sex, fdel=None, doc='Gender of Person')
    uuid1 = property(fget=get_uuid1, fset=None, fdel=None, doc='UUID1 of Person')
    uuid4 = property(fget=get_uuid4, fset=None, fdel=None, doc='UUID4 of Person')
